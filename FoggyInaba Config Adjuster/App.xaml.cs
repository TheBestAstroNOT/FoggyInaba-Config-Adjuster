...
using FoggyInaba_Config_Adjuster.Properties;
using FoggyInaba_Config_Adjuster.Services;
...
public partial class App
{
    ...
    public const string APP_VERSION = "1.5.2"; // Should always be update after every update and needs to match the release tag
    private static readonly IHost _host = Host
        ...
        .ConfigureServices((context, services) =>
        {
            ...
            {
                if (type.Namespace?.StartsWith("FoggyInaba_Config_Adjuster.Views.Pages") == true)
                {
